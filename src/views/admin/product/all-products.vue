        ...
        <tbody>
          <tr v-for="(product, index) in products.data" :key="index">
            ...
            <td>
              <img
                :src="
                  'http://localhost/PFE/back/backend/public/uploads/product_images/' +
            ...
            <td>
              <div class="btn-gorup">
                <div class="btn btn-outline-warning" @click="editProductModal(product)">Edit</div>
                <div class="btn btn-outline-danger" @click="product_delete(product.id)">Delete</div>
              </div>
            </td>
          </tr>
        </tbody>
          ...
          <div class="modal-content">
            <form @submit.prevent=" editMode ? product_update() : product_add() ">
              <div class="modal-header">
                <h5 v-if="editMode" class="modal-title text-success">
                  Product Update
                </h5>
                <h5 v-else class="modal-title text-success">
                  Product Add
                </h5>
                <button
                  type="button"
