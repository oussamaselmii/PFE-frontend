      ...
      <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{sb_id}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
				...
				<div class="col-12"><h3>Recherche : {{sb_id}}</h3></div>
			</div>
			<div class="row">
				<div v-for="(product,index) in products.data" :key="index" class="col-md-3" v-if="product.category_id==sb_id">
  ...
  navbar:navbar,pied:pied
    ...
    data() {
        return {
            ...
            products:{},
            sb_id : this.$route.params.subcategory_name,
        }
    },
    methods: {
